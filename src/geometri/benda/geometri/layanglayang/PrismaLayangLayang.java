...
public class PrismaLayangLayang extends LayangLayang implements BangunRuang, Runnable {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(PrismaLayangLayang.class.getName()).log(Level.SEVERE, null, ex);
        }
