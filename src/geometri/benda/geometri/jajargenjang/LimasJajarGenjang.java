...
public class LimasJajarGenjang extends JajarGenjang implements BangunRuang, Runnable {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(LimasJajarGenjang.class.getName()).log(Level.SEVERE, null, ex);
        }
